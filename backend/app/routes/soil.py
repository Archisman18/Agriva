...
REGIONAL_SOIL_TEXTURES = {
    ...
    "darjeeling": "Gravelly sandy loam to coarse sandy loam",
    "kalimpong": "Gravelly sandy loam to coarse sandy loam",
    "jalpaiguri": "Sandy loam grading into silt loam",
    "alipurduar": "Sandy loam grading into silt loam",
    "cooch behar": "Sandy loam grading into silt loam",
    "uttar dinajpur": "Sandy loam grading into silt loam",
    "dakshin dinajpur": "Silty clay loam to heavy clay loam",
    "malda": "Silty clay loam to heavy clay loam",
    "purulia": "Gravelly sandy clay loam to red gravelly loam",
    "bankura": "Gravelly sandy clay loam to red gravelly loam",
    "paschim medinipur": "Gravelly sandy clay loam to red gravelly loam",
    "west midnapore": "Gravelly sandy clay loam to red gravelly loam",
    "jhargram": "Gravelly sandy clay loam to red gravelly loam",
    "paschim birbhum": "Gravelly sandy clay loam to red gravelly loam",
    "birbhum": "Gravelly sandy clay loam to red gravelly loam",
    "paschim bardhaman": "Gravelly sandy clay loam to red gravelly loam",
    "asansol": "Gravelly sandy clay loam to red gravelly loam",
    "purba bardhaman": "Gravelly sandy clay loam to red gravelly loam",
    "purba medinipur": "Silt loam, loam, and deep silty clay",
    "east midnapore": "Silt loam, loam, and deep silty clay",
    "hooghly": "Silt loam, loam, and deep silty clay",
    "howrah": "Silt loam, loam, and deep silty clay",
    "murshidabad": "Silt loam, loam, and deep silty clay",
    "nadia": "Silt loam, loam, and deep silty clay",
    "north 24 parganas": "Silt loam, loam, and deep silty clay",
    "south 24 parganas": "Silt loam to saline peaty clay in the Sundarbans rim",
